...
A primary goal of the KaliVibeCoding community is to support you and your business in the development, use and implementation of KaliVibeCoding solutions. It’s to be inclusive and add value to the largest number of participants, with the most varied and diverse backgrounds possible. As such, we are committed to providing a friendly, safe and welcoming environment for all.
...
Your participation is contingent upon following these guidelines in all KaliVibeCoding activities, including but not limited to:

* Using KaliVibeCoding community resources.
* Working with other KVC members and other KaliVibeCoding community participants whether virtually or co-located.
* Representing KaliVibeCoding at public events.
* Representing KaliVibeCoding in social media (official accounts, personal accounts, Facebook pages and groups).
* Participating in KaliVibeCoding sprints and training events.
* Participating in KaliVibeCoding-related forums, mailing lists, wikis, websites, chat channels, bugs, group or person-to-person meetings, and KaliVibeCoding-related correspondence.

We invite all those who participate in KaliVibeCoding activities online to help us create safe and positive experiences for everyone, everywhere.
...
Alert KaliVibeCoding team members if you notice a dangerous situation, someone in distress, or violations of this Code of Conduct, even if they seem inconsequential.
...
If you are subject to or witness unacceptable behavior, or have any other concerns, please notify us as soon as possible by emailing contact@kalivibecoding.com, or contacting a KaliVibeCoding team member on the specific platform.

Processes for dealing with breaches of the Code of Conduct can be found [here][coc-breaches].

## 8. Addressing Grievances
Only permanent resolutions (such as bans) may be appealed. To appeal a decision, contact the KaliVibeCoding team at contact@kalivibecoding.com with your appeal and the team will review the situation.
...
While this code of conduct is specifically aimed at KaliVibeCoding’s official resources and community, we recognize that it is possible for actions taken outside of KaliVibeCoding’s official online or in person spaces to have a deep impact on community health.

Resources or incidents which break this code of conduct for any reason in a non-KaliVibeCoding community location will be considered in the same way as resources or incidents from owned channels, and subject to the same sanctions.

## 10. Contact info
For more information, please contact contact@kalivibecoding.com.
