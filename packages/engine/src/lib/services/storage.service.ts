...
import { Store, StoreScope } from '@kvc/pieces-framework' // KVC: Scope updated
import { DeleteStoreEntryRequest, FlowId, isNil, PutStoreEntryRequest, STORE_KEY_MAX_LENGTH, STORE_VALUE_MAX_SIZE, StoreEntry } from '@kvc/shared' // KVC: Scope updated
